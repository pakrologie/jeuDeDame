...
namespace WindowsFormsApplication2
{
    class Attack
    {
        public static Point GetCoordsAttakedOpponent(int y1, int x1, int y2, int x2, bool playerTop)
        {
        ...
        public static bool detectCanAtk(Joueur Player, int x, int y)
        {
        ...
        public static bool detectCanAtkForKing(Joueur Player, int x, int y)
        {
            bool playerTop = Player.infos.playerTop;
